...
The **Proportional Symbol** layer type allows scaling of point symbols based on the value of a selected attribute for each data point.. This is one option type for `MultiPoint` GeoJSON datasets.
