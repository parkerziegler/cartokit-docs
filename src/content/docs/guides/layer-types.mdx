...
The **Dot Density** layer type distributes points within polygon boundaries, with the number of points proportional to a selected attribute value. This is one option type for `MultiPoint` GeoJSON datasets.
