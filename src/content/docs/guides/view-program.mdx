...
To get the program into your own code editor, click the **Open Editor** button on the bottom right (or hit **E** on your keyboard), copying the program using the **Clipboard** button in the top right (or hit **P** on your keyboard), and then pasting the program into your editor of choice. 

<Video src="/program-into-ide.mp4" />
